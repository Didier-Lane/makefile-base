...
>[!IMPORTANT]
>The `--prefix=make/base` argument is mandatory because of the [directory structure](../README.md#directory-structure
) of this project
...
You can now start to add [your own recipes](../README.md#adding-recipes) to extend functionnalities for your project
